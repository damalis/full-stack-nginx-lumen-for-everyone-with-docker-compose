# [full stack nginx Lumen for everyone with docker compose](https://github.com/damalis/full-stack-nginx-lumen-for-everyone-with-docker-compose)

If You want to build a website with Lumen "webapp" at short time;

#### Full stack Nginx Lumen "webapp":
...
```
git clone https://github.com/damalis/full-stack-nginx-lumen-for-everyone-with-docker-compose.git
```

Open a terminal and `cd` to the folder in which `docker-compose.yml` is saved and run:

```
cd full-stack-nginx-lumen-for-everyone-with-docker-compose
chmod +x install.sh
./install.sh
```
